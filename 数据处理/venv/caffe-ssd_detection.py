...
def test_video(args):
    ...
    cap = cv2.VideoCapture('/home/chenchaocun/caffe-ssd/e-bike/demo.mpg')
    while(cap.isOpened()):
        ret, frame = cap.read()
...
def test_img(args):
    ...
    im_names = os.listdir('/home/chenchaocun/caffe-ssd/e-bike/test_img/')
    cc =0
    save_path = '/home/chenchaocun/caffe-ssd/e-bike/result_img/'+str(cc)+'.jpg'
    for f in im_names:
        print(f)
        img = cv2.imread('/home/chenchaocun/caffe-ssd/e-bike/test_img/'+f)
        result = detection.detect('/home/chenchaocun/caffe-ssd/e-bike/test_img/'+f, args.thresh)

        for item in result:
            cv2.rectangle(img, (item[0], item[1]), (item[2], item[3]), (0,255,0), 2)
            cv2.putText(img, str(item[5]), (item[0],item[1]), cv2.FONT_HERSHEY_COMPLEX, 2, (0,0,255), 1)
...
def parse_args():
    ...
    parser.add_argument('--labelmap_file',
                        default='/home/chenchaocun/caffe-ssd/e-bike/labelmap_voc.prototxt')
    parser.add_argument('--model_def',
                        default='/home/chenchaocun/caffe-ssd/e-bike/deploy-e-bike-384-8.prototxt')
    parser.add_argument('--image_resize', default=384, type=int)
    parser.add_argument('--thresh', default=0.1, type=float)
    parser.add_argument('--model_weights',
                        default='/home/chenchaocun/caffe-ssd/e-bike/e-bike-384_iter_30000.caffemodel')
